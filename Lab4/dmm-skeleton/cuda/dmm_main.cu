...
#ifndef EPS
#define EPS MAKE_VALUE_CONSTANT(1.e-4)
#endif
...
int main(int argc, char **argv) {
   ...
   */
  dim3 gpu_block(THREAD_BLOCK_Y, THREAD_BLOCK_X); // FILLME: set up the thread block dimensions
  dim3 gpu_grid((N+THREAD_BLOCK_Y-1)/THREAD_BLOCK_Y, (M+THREAD_BLOCK_X-1)/THREAD_BLOCK_X);  // FILLME: set up the grid dimensions
